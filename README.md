...
| Skill | Description |
|-------|-------------|
| [anki-connect](https://github.com/doggy8088/agent-skills/tree/main/skills/anki-connect) | This skill is for interacting with Anki through AnkiConnect, and should be used whenever a user asks to interact with Anki, including to read or modify decks, notes, cards, models, media, or sync operations. |
| | ```npx skills add intellectronica/agent-skills --skill anki-connect``` |
| | ```claude plugin install anki-connect@intellectronica-skills``` |
| [beautiful-mermaid](https://github.com/doggy8088/agent-skills/tree/main/skills/beautiful-mermaid) | Render Mermaid diagrams as SVG and PNG using the Beautiful Mermaid library. Use when the user asks to render a Mermaid diagram. |
